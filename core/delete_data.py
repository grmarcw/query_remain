...
async def handle_show_or_delete_request(user_answer, instance):
    ...
    if user_answer in ("удалить", "удалить данные"):
        ...
        return (
            ...
            button_generator(
                ["Все данные", "Данные о поставках", "Данные об остатке продукции"]
            ),
        ...
        if user_data_from_db is None:
            ...
            output.append(
                renderers.render_list_or_dict(user_data_from_db.recipes, 4, option=3)
            )
            ...
            if data_balance is not None:
                ...
                output.append(general.INPUT_START)
    ...
    if user_answer == "отменить":
        ...
        return (
            general.INPUT_DATA_FOR_DELETE.format(
                sep=general.SEPARATOR, data="  •Все данные\n  •Данные о поставках"
            ),
